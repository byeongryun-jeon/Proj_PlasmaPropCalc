...
'/home/brjeon/Proj_PlasmaPropCalc/data/processed/thermo/argon_mutationpp_reference_0p1_1_4atm.csv' u 1:(abs($2-0.1)<1e-12 ? $3 : 1/0) w l lw 2 dt 3 lc rgb '#1f77b4' title 'Mutationpp 0.1 atm', \
...
'/home/brjeon/Proj_PlasmaPropCalc/data/processed/thermo/argon_mutationpp_reference_0p1_1_4atm.csv' u 1:(abs($2-1)<1e-12 ? $3 : 1/0) w l lw 2 dt 3 lc rgb '#d62728' title 'Mutationpp 1 atm', \
...
'/home/brjeon/Proj_PlasmaPropCalc/data/processed/thermo/argon_mutationpp_reference_0p1_1_4atm.csv' u 1:(abs($2-4)<1e-12 ? $3 : 1/0) w l lw 2 dt 3 lc rgb '#2ca02c' title 'Mutationpp 4 atm'
