...
set output '/home/brjeon/Proj_PlasmaPropCalc/data/processed/thermo/plots/cp_vs_T_10000_20000K.png'
set grid
set key outside right top
set xlabel 'Temperature [K]'
set ylabel 'Cp [J/(kg K)]'
set title 'Specific Heat at Constant Pressure (10000-20000 K)'
